  ...
  return (
    <section className="bg-cream text-center py-16 px-6">
      <div className="max-w-[720px] mx-auto">
        ...
        <Reveal><h2 className="font-serif text-fluid-title font-light leading-[1.2] mb-4 text-dusty-dark">Season's Hotel</h2></Reveal>
        ...
        <Reveal>
          <a href="https://www.google.com/maps/search/Season%27s+Hotel+San+Jose+Occidental+Mindoro"
