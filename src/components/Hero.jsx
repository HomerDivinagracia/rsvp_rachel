  ...
  return (
    <section className="relative h-screen min-h-[600px] flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-10 text-white px-8">
        ...
        <div className="animate-hero-3 w-[60px] h-px bg-gradient-to-r from-dusty-light via-gold to-dusty-light mx-auto my-6" />
      ...
      <div className="absolute bottom-8 left-0 right-0 flex justify-center z-10">
        <div className="flex flex-col items-center gap-1 text-white/60 text-[0.65rem] tracking-[0.2em] uppercase animate-bounce">
